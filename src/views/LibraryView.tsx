  ...
  return (
    ...
    >
      ...
      <div className="fnr-book-card-info">
        <div className="fnr-book-card-title">
          {book.title || book.vaultPath}
        </div>
        {book.author && (
  ...
  const renderContent = () => {
      ...
      if (recentBooks.length === 0) {
        return (
          <div className="fnr-library-empty">
            {query ? t("library.noResults") : t("library.recent.empty")}
          </div>
        );
      }
    ...
    if (activeTab === "favorites") {
      if (favBooks.length === 0) {
        return (
          <div className="fnr-library-empty">
            {query ? t("library.noResults") : t("library.favorites.empty")}
          </div>
        );
      }
