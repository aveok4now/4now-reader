	...
	return (
		<div className="fnr-typography-popover">
			...
			<div className="fnr-popover-row">
				...
				<span className="fnr-popover-value">{rangePct(settings.lineHeight, SLIDER_LIMITS.lineHeight)}%</span>
			</div>
			<input
				type="range"
			...
			<div className="fnr-popover-row">
				...
				<span className="fnr-popover-value">{Math.round(settings.textWidth / SLIDER_LIMITS.textWidth.max * 100)}%</span>
			</div>
			<input
				type="range"
			...
			<input
				...
				list="fnr-font-datalist"
				placeholder={t("settings.fontFamily.name")}
				value={settings.fontFamily}
				onChange={(e) => onSettingsChange({ fontFamily: e.target.value })}
			/>
			{systemFonts.length > 0 && (
				<datalist id="fnr-font-datalist">
