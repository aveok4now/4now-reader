...
function getThemeStyles(theme: Read4sidianSettings['readerTheme']): Record<string, string> {
  switch (theme) {
    case 'light':
...
export function EpubRenderer({ book, settings, initialCfi, onProgress }: EpubRendererProps) {
